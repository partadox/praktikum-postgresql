...
\input{sections/persiapan_praktikum}

% Modul P1
\setcounter{section}{0}
\input{sections/praktikum1_indexing}

% Modul P2
\setcounter{section}{0}
\input{sections/praktikum2_acid}

% Modul P3
\setcounter{section}{0}
\input{sections/praktikum3_partitioning}

% Modul P4
\setcounter{section}{0}
\input{sections/praktikum4_backup}
